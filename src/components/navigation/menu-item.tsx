  ...
  return (
    <Link
      ...
      className={cn(
        ...
        collapsed
          ? "gap-0 md:px-0 md:py-2 md:justify-center"
          : "gap-3 px-3 py-2",
        active &&
    ...
    >
      <span
        className={cn(
          "grid h-5 w-5 place-items-center text-neutral-500 group-hover:text-neutral-900 dark:text-neutral-400 dark:group-hover:text-neutral-50",
