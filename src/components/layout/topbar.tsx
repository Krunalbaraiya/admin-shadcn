  ...
  return (
    <header className="sticky top-0 z-30 border-b bg-white/70 backdrop-blur supports-[backdrop-filter]:bg-white/70 dark:border-neutral-800 dark:bg-neutral-950/70">
      <div className="flex h-14 items-center gap-3 px-3 sm:px-4">
        ...
        <div className={cn("min-w-0 flex-1", !title && "sr-only")}>
          {title && (
        ...
        <ThemeToggle />
        <button
          className="relative inline-flex h-9 w-9 items-center justify-center rounded-md hover:bg-neutral-100 focus:outline-none focus:ring-2 focus:ring-neutral-400 dark:hover:bg-neutral-800 dark:focus:ring-neutral-600"
  ...
  return (
    <div className="relative">
      ...
      {open && (
        <div
          role="menu"
          className="absolute right-0 mt-2 w-56 overflow-hidden rounded-md border bg-white shadow-lg dark:border-neutral-800 dark:bg-neutral-900"
        >
          ...
          <button className="w-full px-3 py-2 text-left text-sm hover:bg-neutral-100 dark:hover:bg-neutral-800">
            Profile
          </button>
          <button className="w-full px-3 py-2 text-left text-sm hover:bg-neutral-100 dark:hover:bg-neutral-800">
            Settings
          </button>
          <button className="w-full px-3 py-2 text-left text-sm text-red-600 hover:bg-neutral-100 dark:hover:bg-neutral-800">
            Sign out
          </button>
        </div>
      )}
